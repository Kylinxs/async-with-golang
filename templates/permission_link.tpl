{if $permission_link.mode eq 'text'}
    <a class="tips link-list {if !empty($permission_link.active)}tips bg-warning{/if}{if !empty($permission_link.addclass)} {$permission_link.addclass}{/if}" href="{$permission_link.url|escape}"{if $permission_link.active} title=":{tr}Individual permissions{/tr}"{/if}>
...
{elseif $permission_link.mode eq 'icon'}
    ...
    {/strip}
{else}
    <a class="tips {if !empty($permission_link.active)}text-success{else}text-warning{/if}{if !empty($permission_link.addclass)} {$permission_link.addclass}{/if}" href="{$permission_link.url|escape}" title=":{$permission_link.label|escape}">
        {icon name="permission"}
        <span class="sr-only">{$permission_link.label|escape}</span>
        {if !empty($permission_link.count)}
            <span class="badge bg-secondary">{$permission_link.count|escape}</span>
