{remarksbox type="tip" title="{tr}Tip{/tr}"}
    {tr _0='<a class="alert-link" href="tiki-admin_rssmodules.php" title="{tr}External Feeds{/tr}">' _1='</a>'}Use this page to configure the feeds generated by Tiki. To syndicate feeds from other sites, use %0External Feeds%1.{/tr}
{/remarksbox}
<form action="tiki-admin.php?page=rss" method="post" class="admin">
    ...
    {tabset name="admin_rss"}
        ...
        {tab name="{tr}Feeds{/tr}"}
            ...
            <div class="adminoptionboxchild mb-3 row clearfix" id="feed_blog_childcontainer">
                <div class="mb-3 row clearfix">
                    <div class="col-md-8 offset-md-4">
