...
// "In the products tracker, the ID of the field to store the total inventory of products less the amount on hold because they are currently in carts" => "In the products tracker, the ID of the field to store the total inventory of products less the amount on hold because the