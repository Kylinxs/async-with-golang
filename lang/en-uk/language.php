...
// "Name of the preference to manipulate. avatar, location, password and email are not preferences, but are also valid values that will modify the user's profile" => "Name of the preference to manipulate. avatar, location, password and email are not preferenc